# Contributing to Exploring-SceneKit
...
## Report bugs using Github's [issues](https://github.com/chicio/Exploring-SceneKit/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/chicio/Exploring-SceneKit/issues/new/choose "opening an issue"); it's that easy! :purple_heart:
...
## License
By contributing, you agree that your contributions will be licensed under its [MIT License](https://github.com/chicio/Exploring-SceneKit/blob/master/LICENSE.md).
